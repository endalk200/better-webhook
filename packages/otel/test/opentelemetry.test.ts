...
import { type OtelSpan, otel } from "../src/index.js";
...
class FakeSpan implements OtelSpan {
	...
	public addEvent(): void {
		// FakeSpan records attributes only; events are irrelevant for these assertions.
	}

	public recordException(): void {
		// FakeSpan records attributes only; exceptions are irrelevant for these assertions.
	}
