 ...
 * The keys correspond to the value of the X-GitHub-Event header.
 * @see https://docs.github.com/en/webhooks/webhook-events-and-payloads
 */
const GitHubSchemas = {
  ...
  /** Installation event - GitHub App installed or uninstalled */
  installation: GitHubInstallationEventSchema,
  /** Installation repositories event - repos added/removed from app */
  installation_repositories: GitHubInstallationRepositoriesEventSchema,
} as const;
 ...
 *     console.log(`Repositories ${payload.action}`);
 *   });
 * ```
 */
