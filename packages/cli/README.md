...
CLI releases are separate from SDK Changesets releases. Maintainers publish real CLI releases from annotated tags such as `cli/v2.0.0-beta.4`. Beta versions publish to the npm `beta` dist-tag and stable versions publish to `latest`.
