...
```bash
bw templates run github-push http://localhost:3000/api/webhooks/github --secret "$GITHUB_WEBHOOK_SECRET"
```
...
## `bw` command is not found after installation
...
- If testing a prerelease, prefer:
