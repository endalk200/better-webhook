...
3. **Environment variables** — Automatically checks `GITHUB_WEBHOOK_SECRET`, `STRIPE_WEBHOOK_SECRET`, `RAGIE_WEBHOOK_SECRET`, `RECALL_WEBHOOK_SECRET`, `RESEND_WEBHOOK_SECRET`, etc.
