...
- **Provider packages** — Type definitions and schemas for webhook sources (GitHub, Stripe, Ragie, Recall.ai)
...
3. **Environment variables** — Automatically checks `GITHUB_WEBHOOK_SECRET`, `STRIPE_WEBHOOK_SECRET`, `RAGIE_WEBHOOK_SECRET`, `RECALL_WEBHOOK_SECRET`, etc.
...
- [Providers](/docs/sdk/providers) — GitHub, Stripe, Ragie, and Recall.ai provider documentation with all supported events
...
- [Adapter Options](/docs/sdk/adapter-options) — Shared options for secrets, limits, and observability
