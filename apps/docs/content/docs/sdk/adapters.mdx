...
description: Integrate Better Webhook with Next.js, Express, NestJS, GCP Cloud Functions, and Hono.
---
...
| `onSuccess` | `(eventType: string) => void \| Promise<void>` | Callback invoked after a registered handler successfully processes the webhook. Errors from this callback are ignored. |
...
// Hono
app.post("/webhooks/github", toHono(webhook, { observer: stats.observer }));
```
