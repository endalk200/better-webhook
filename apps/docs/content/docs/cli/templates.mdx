...
1. Go to the **Captures** tab
2. Select a captured webhook
3. Click **Save as Template**
4. Fill in the template details (ID is auto-suggested)
5. Click **Save Template**

The saved template will appear in your local templates and can be run with:

```bash
better-webhook run github-push-custom --url http://localhost:3000/api/webhooks
```
